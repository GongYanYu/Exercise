...
class PagerPhotoListAdapter:ListAdapter <PhotoItem,PagerPhotoViewHolder>(object :DiffUtil.ItemCallback<PhotoItem>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagerPhotoViewHolder {
        //return PagerPhotoViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.fragment_pager_photo,parent,false))
